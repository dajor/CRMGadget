package gadget.util
{
	...
	public class EncryptionKeyGenerator
	{
		...
		public static const MESSAGE_STRONG_PASSWORD:String = "The password must be a strong password. It must be 8-32 characters long. It must contain at least one uppercase letter, at least one lowercase letter, and at least one number or symbol.";
		...
		// ------- Public methods -------
		public static function validateStrongPassword(password:String):Boolean
		{
		...
		public function getEncryptionKey(dbFile:File, password:String, saltELSKey:String=null):ByteArray
		{
			...
			{
				throw new ArgumentError(MESSAGE_STRONG_PASSWORD);
			}*/
