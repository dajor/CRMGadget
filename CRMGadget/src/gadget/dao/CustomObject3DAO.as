// semi-automatically generated from Custom Object 3.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class CustomObject3DAO extends CustomeObjectBaseDao {

		public function CustomObject3DAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_customobject3',
				oracle_id: 'Id',
				name_column: [ 'Name' ],
				search_columns: [ 'Name' ],
				display_name : "CustomObject3",	//___EDIT__THIS___
				index: [ 'Id' ],
		...
		override public function get entity():String {
			return "Custom Object 3";	//VAHI corrected spel_ing
		}
		
		
		public function get queryFields():Array{
			//"Plant","Material Number","Material EAN", "Consumable",   "Deletion Flag"
			var fields:Array=['Id','Name','ProductName','QuickSearch1','IndexedBoolean0','CustomBoolean0'];
			return fields;
		}
