// semi-automatically generated from CustomObject13.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class CustomObject13DAO extends CustomeObjectBaseDao {

		public function CustomObject13DAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_customobject13',
				oracle_id: 'Id',
				name_column: [ 'Name' ],
				search_columns: [ 'Name' ],
				display_name : "CustomObject13",	//___EDIT__THIS___
				index: [ 'Id' ],
