// semi-automatically generated from CustomObject5.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class CustomObject5DAO extends CustomeObjectBaseDao {

		public function CustomObject5DAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_customobject5',
				oracle_id: 'Id',
				name_column: [ 'Name' ],
				search_columns: [ 'Name' ],
				display_name : "CustomObject5",	//___EDIT__THIS___
				index: [ 'Id' ],
