// semi-automatically generated from InvolvedParty.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class InvolvedPartyDAO extends BaseDAO {

		public function InvolvedPartyDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_involvedparty',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "InvolvedParty",	//___EDIT__THIS___
				index: [ 'Id' ],
