// semi-automatically generated from CustomObject6.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class CustomObject6DAO extends CustomeObjectBaseDao {

		public function CustomObject6DAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_customobject6',
				oracle_id: 'Id',
				name_column: [ 'Name' ],
				search_columns: [ 'Name' ],
				display_name : "CustomObject6",	//___EDIT__THIS___
				index: [ 'Id' ],
