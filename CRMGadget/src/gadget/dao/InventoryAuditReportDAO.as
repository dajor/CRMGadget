// semi-automatically generated from CRMODLS_InventoryAuditReport.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class InventoryAuditReportDAO extends BaseDAO {

		public function InventoryAuditReportDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_inventoryauditreport',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "InventoryAuditReport",	//___EDIT__THIS___
				index: [ 'Id' ],
