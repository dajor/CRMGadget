package gadget.dao
{
	...
	public class CampaignDAO extends BaseDAO {
		...
		public function CampaignDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'campaign',
				oracle_id: 'CampaignId',
		...
		private var textColumns:Array = ["ActualCost",
			"Audience",
			"BudgetedCost",
			"CampaignId",
			"CampaignName",
