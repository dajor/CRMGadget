// semi-automatically generated from CRMODLS_SampleInventory.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class SampleInventoryDAO extends BaseDAO {

		public function SampleInventoryDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_sampleinventory',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "SampleInventory",	//___EDIT__THIS___
				index: [ 'Id' ],
