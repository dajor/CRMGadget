// semi-automatically generated from Household.wsdl
package gadget.dao
{
	...
	public class HouseholdDAO extends BaseDAO {
		...
		public function HouseholdDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_household',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "Household",	//___EDIT__THIS___
				index: [ 'Id' ],
