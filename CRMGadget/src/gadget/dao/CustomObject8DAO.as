// semi-automatically generated from CustomObject8.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class CustomObject8DAO extends CustomeObjectBaseDao {

		public function CustomObject8DAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_customobject8',
				oracle_id: 'Id',
				name_column: [ 'Name' ],
				search_columns: [ 'Name' ],
				display_name : "CustomObject8",	//___EDIT__THIS___
				index: [ 'Id' ],
