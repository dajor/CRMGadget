// semi-automatically generated from Claim.wsdl
package gadget.dao
{
	...
	public class ClaimDAO extends BaseDAO {
		...
		public function ClaimDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_claim',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],	//___EDIT__THIS___
				display_name : "Claim",	//___EDIT__THIS___
				index: [ 'Id' ],
		...
		private var textColumns:Array = [
			...
			"CustomText89",
			"CustomText9",
			"DateofEmployerAwareofClaim",
			"DateofEmployerAwareofInjury",
			"EmployeeInjuredNumber",
			"EventNumber",
			"ExchangeDate",
			"ExternalLastUpdated",
			"ExternalSource",
