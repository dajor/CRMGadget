// semi-automatically generated from Vehicle.wsdl
package gadget.dao
{
	...
	public class VehicleDAO extends BaseDAO {
		...
		public function VehicleDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_vehicle',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "Vehicle",	//___EDIT__THIS___
				index: [ 'Id' ],
