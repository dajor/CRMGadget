// semi-automatically generated from CRMODLS_BPL_CNTCT.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class PlanContactDAO extends BaseDAO {

		public function PlanContactDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_plancontact',
				oracle_id: 'Id',
				name_column: [ 'ContactFullName' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "PlanContact",	//___EDIT__THIS___
				index: [ 'Id' ],
