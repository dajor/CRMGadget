// semi-automatically generated from CustomObject15.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class CustomObject15DAO extends CustomeObjectBaseDao {

		public function CustomObject15DAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_customobject15',
				oracle_id: 'Id',
				name_column: [ 'Name' ],
				search_columns: [ 'Name' ],
				display_name : "CustomObject15",	//___EDIT__THIS___
				index: [ 'Id' ],
