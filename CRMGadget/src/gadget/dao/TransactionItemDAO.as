// semi-automatically generated from CRMOD_LS_TransactionItems.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class TransactionItemDAO extends BaseDAO {

		public function TransactionItemDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_transactionitem',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "TransactionItem",	//___EDIT__THIS___
				index: [ 'Id' ],
		...
		private var textColumns:Array = [
			...
			"SampleTransactionTransactionStatus",
			"SampleTransactionTransactionType",
			"ShippedQuantity",
			"UpdatedByAlias",
			"UpdatedByEMailAddr",
