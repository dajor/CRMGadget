// semi-automatically generated from CRMOD_LS_MessagingPlan.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class MessagePlanDAO extends BaseDAO {

		public function MessagePlanDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_messageplan',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "MessagePlan",	//___EDIT__THIS___
				index: [ 'Id' ],
