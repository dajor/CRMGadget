// semi-automatically generated from CRMODLS_BusinessPlan.wsdl
package gadget.dao
{
	...
	public class BusinessPlanDAO extends CustomeObjectBaseDao {

		public function BusinessPlanDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_businessplan',
				oracle_id: 'Id',
				name_column: [ 'PlanName' ],	//___EDIT__THIS___
				search_columns: [ 'PlanName' ],	//___EDIT__THIS___
				display_name : "BusinessPlan",	//___EDIT__THIS___
				index: [ 'Id' ],
...
/*
			"ListOfActivity",
			"ListOfBusinessPlanChild",
			"ListOfObjectives",
			"ListOfPlanAccount",
			"ListOfPlanContact",
			"ListOfPlanOpportunity",
*/
			"ModId",
			"ModifiedBy",
			"ModifiedById",
			...
			"PlanName",
			"Planrevenue",
			"PrincipalPartnerChannelAccountManagerAlias",
