package gadget.dao
{
	...
	public class CustomObject14DAO extends CustomeObjectBaseDao {

		public function CustomObject14DAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'custom_object_14',
				oracle_id: 'Id',
				name_column: [ 'Name' ],
				search_columns: [ 'Name' ],
				display_name : "custom object 14",
				index: ["Id" ],
