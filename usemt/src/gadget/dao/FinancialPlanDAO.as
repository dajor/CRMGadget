// semi-automatically generated from FinancialPlan.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class FinancialPlanDAO extends BaseDAO {

		public function FinancialPlanDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_financialplan',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "FinancialPlan",	//___EDIT__THIS___
				index: [ 'Id' ],
