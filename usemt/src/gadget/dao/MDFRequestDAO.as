// semi-automatically generated from MDFRequest.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class MDFRequestDAO extends BaseDAO {

		public function MDFRequestDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_mdfrequest',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "MDFRequest",	//___EDIT__THIS___
				index: [ 'Id' ],
