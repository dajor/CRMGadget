// semi-automatically generated from CRMOD_LS_Allocation.wsdl
package gadget.dao
{
	...
	public class AllocationDAO extends BaseDAO {
		...
		public function AllocationDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_allocation',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],	//___EDIT__THIS___
				display_name : "Allocation",	//___EDIT__THIS___
				index: [ 'Id' ],
