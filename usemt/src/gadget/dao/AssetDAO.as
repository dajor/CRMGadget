// semi-automatically generated from Asset.wsdl
package gadget.dao
{
	...
	public class AssetDAO extends BaseDAO {
		...
		public function AssetDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_asset',
				oracle_id: 'Id',
				name_column: [ 'Product' ],	//___EDIT__THIS___
				search_columns: [ 'Id','Product' ],	//___EDIT__THIS___
				display_name : "Asset",	//___EDIT__THIS___
				index: [ 'Id','Product' ],
