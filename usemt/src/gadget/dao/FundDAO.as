// semi-automatically generated from Fund.wsdl
package gadget.dao
{
	...
	public class FundDAO extends BaseDAO {
		...
		public function FundDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_fund',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "Fund",	//___EDIT__THIS___
				index: [ 'Id' ],
