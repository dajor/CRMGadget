// semi-automatically generated from Solution.wsdl
package gadget.dao
{
	...
	public class SolutionDAO extends BaseDAO {
		...
		public function SolutionDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_solution',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "Solution",	//___EDIT__THIS___
				index: [ 'Id' ],
...
*/
			...
			"SolutionRating",
			"Status",
			"ThumbnailDistributionMethod",
			"ThumbnailExpirationDate",
			"ThumbnailExternalSystemId",
			"ThumbnailId",
			"ThumbnailIntegrationId",
			"ThumbnailLegalApproval",
			"ThumbnailMarketingApproval",
			"ThumbnailMultiFileAsset",
			"ThumbnailPCDAttachmentType",
			"ThumbnailReleaseDate",
			"ThumbnailStatus",
			"ThumbnailTitle",
			"ThumbnailVerificationStatus",
			"Title",
			"UpdatedByAlias",
			"UpdatedByEMailAddr",
