// semi-automatically generated from DealRegistration.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class DealRegistrationDAO extends BaseDAO {

		public function DealRegistrationDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_dealregistration',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "DealRegistration",	//___EDIT__THIS___
				index: [ 'Id' ],
		...
		private var textColumns:Array = [
			"ApprovedDate",
			"AssociatedContactAccountName",
			"AssociatedContactContactEmail",
			"AssociatedContactContactFirstName",
			"AssociatedContactContactFullName",
			"AssociatedContactContactLastName",
			"AssociatedContactExternalSystemId",
			"AssociatedContactId",
			"AssociatedContactIntegrationId",
			"CellPhone",
			"City",
			"CloseDate",
			"CompanyName",
			"ConsolidatorAccountName",
			"ConsolidatorAccountType",
			"ConsolidatorExternalSystemId",
			"ConsolidatorId",
			"ConsolidatorIntegrationId",
			"ConsolidatorLocation",
			"ConsolidatorOwner",
			"ConsolidatorPriority",
			...
			"CurrentApproverEMailAddr",
			"CurrentApproverExternalSystemId",
			"CurrentApproverFirstName",
			"CurrentApproverFullName",
			"CurrentApproverId",
			"CurrentApproverIntegrationId",
			"CurrentApproverLastName",
			"CurrentApproverUserSignInId",
			"CustomBoolean0",
			"CustomBoolean1",
			"CustomBoolean10",
			"CustomBoolean11",
			...
			"DistributorExternalSystemId",
			"DistributorId",
			"DistributorIntegrationId",
			"DistributorLocation",
			"DistributorOwner",
			"DistributorPriority",
			...
			"Fax",
			"FinalApproverAlias",
			"FinalApproverEMailAddr",
			"FinalApproverExternalSystemId",
			"FinalApproverFirstName",
			"FinalApproverFullName",
			"FinalApproverId",
			"FinalApproverIntegrationId",
			"FinalApproverLastName",
			"FinalApproverUserSignInId",
			"FirstName",
			"ForNewOpportunity",
			"Id",
			"IndexedBoolean0",
