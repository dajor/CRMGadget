// semi-automatically generated from CRMODLS_PCD_MSGRSP.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class MessageResponseDAO extends BaseDAO {

		public function MessageResponseDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_messageresponse',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "MessageResponse",	//___EDIT__THIS___
				index: [ 'Id' ],
