...
package gadget.dao
{
	...
	public class ContactLicenseDAO extends BaseDAO {

		public function ContactLicenseDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_contactlicense',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],	//___EDIT__THIS___
				display_name : "ContactLicense",	//___EDIT__THIS___
				index: [ 'Id' ],
