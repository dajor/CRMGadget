package gadget.dao
{
	...
	public class LeadDAO extends BaseDAO implements DAO{
		
		private var stmtFindContact:SQLStatement;
		
		public function LeadDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection,
				{
					table: 'lead',
					oracle_id: 'LeadId',
					name_column: ['LeadFirstName', 'LeadLastName'],
					search_columns: ['LeadFirstName', 'LeadLastName'],
					display_name : "leads",
					index: ['LeadId', "UpperName", "Deleted", "local_update"],
					columns: { 'TEXT' : textColumns }
				});
			stmtFindContact = new SQLStatement();
			stmtFindContact.sqlConnection = sqlConnection;
			stmtFindContact.text = "SELECT * FROM lead WHERE ContactId = :contactId AND CampaignId = :campaignId";
		}
/*
...
*/	
		...
		private static const INGNORE_FIELDS:ArrayCollection=new ArrayCollection(
			[
				...
				"ContactFirstName",
				"ContactFullName",
				"ContactFuriganaFirstName",
				"ContactFuriganaLastName",
				"ContactIntegrationId",
				"ContactLastName",
				"OpportunityExternalSystemId",				
				"OpportunityIntegrationId",
				"OpportunityName",				
				"SalesPersonExternalSystemId",
		...
		public function checkExistContact(contactId:String, campaignId:String):Boolean{
			...
			stmtFindContact.parameters[":campaignId"] = campaignId;
			exec(stmtFindContact);
			stmtFindContact.clearParameters();
			var result:SQLResult = stmtFindContact.getResult()
			if(result.data == null)
				return false;
			return true;
		}
