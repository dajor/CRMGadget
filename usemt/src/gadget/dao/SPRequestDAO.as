// semi-automatically generated from SPRequest.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class SPRequestDAO extends BaseDAO {

		public function SPRequestDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_sprequest',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "SPRequest",	//___EDIT__THIS___
				index: [ 'Id' ],
		...
		private var textColumns:Array = [
			...
			"ApproverAlias",
			"ApproverEMailAddr",
			"ApproverExternalSystemId",
			"ApproverFirstName",
			"ApproverFullName",
			"ApproverId",
			"ApproverIntegrationId",
			"ApproverLastName",
			"ApproverUserSignInId",
			"AuthorizedDate",
			"ClaimDecisionDate",
			"ClaimStatus",
			"CreatedBy",
			...
			"EndCustomerAccountType",
			"EndCustomerExternalSystemId",
			"EndCustomerId",
			"EndCustomerIntegrationId",
			"EndCustomerLocation",
			"EndCustomerOwner",
			"EndCustomerPriority",
			...
			"IntegrationId",
			"LastApprovedByAlias",
			"LastApprovedByEMailAddr",
			"LastApprovedByExternalSystemId",
			"LastApprovedByFirstName",
			"LastApprovedByFullName",
			"LastApprovedById",
			"LastApprovedByIntegrationId",
			"LastApprovedByLastName",
			"LastApprovedByUserSignInId",
/*
			"ListOfActivity",
			"ListOfBook",
			"ListOfCustomObject1",
...
*/
			...
			"OpportunityOwner",
			"OpportunityRevenue",
			"OriginallyPre_ApprovedAmount",
			"OriginatingPartnerAccountChannelAccountManagerAlias",
			"OriginatingPartnerAccountExternalSystemId",
			"OriginatingPartnerAccountId",
			"OriginatingPartnerAccountIntegrationId",
			"OriginatingPartnerAccountLocation",
			...
			"OwnerIntegrationId",
			"OwnerLastName",
			"OwnerPartnerAccountChannelAccountManagerAlias",
			"OwnerPartnerAccountExternalSystemId",
			"OwnerPartnerAccountId",
			"OwnerPartnerAccountIntegrationId",
			"OwnerPartnerAccountLocation",
			...
			"PrincipalPartnerAccountPartnerName",
			"RejectReason",
			"RequestDate",
			"SPRequestName",
			"StartDate",
