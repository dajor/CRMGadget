// semi-automatically generated from CustomObject4.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class CustomObject4DAO extends CustomeObjectBaseDao {

		public function CustomObject4DAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_customobject4',
				oracle_id: 'Id',
				name_column: [ 'Name' ],
				search_columns: [ 'Name' ],
				display_name : "CustomObject4",	//___EDIT__THIS___
				index: [ 'Id' ],
