// semi-automatically generated from Damage.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class DamageDAO extends BaseDAO {

		public function DamageDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_damage',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "Damage",	//___EDIT__THIS___
				index: [ 'Id' ],
