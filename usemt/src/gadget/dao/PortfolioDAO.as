// semi-automatically generated from Portfolio.wsdl
package gadget.dao
{
	...
	public class PortfolioDAO extends BaseDAO {
		...
		public function PortfolioDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_portfolio',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "Portfolio",	//___EDIT__THIS___
				index: [ 'Id' ],
...
*/
			...
			"OwnerGroupName",
			"OwnerId",
			"ParentPortfolioAccountExternalSystemId",
			"ParentPortfolioAccountId",
			"ParentPortfolioAccountNumber",
			"Premium",
			"PrimaryContact",
