// semi-automatically generated from InsuranceProperty.wsdl
package gadget.dao
{
	import flash.data.SQLConnection;

	public class InsurancePropertyDAO extends BaseDAO {

		public function InsurancePropertyDAO(sqlConnection:SQLConnection, work:Function) {
			super(work, sqlConnection, {
				table: 'sod_insuranceproperty',
				oracle_id: 'Id',
				name_column: [ 'Id' ],	//___EDIT__THIS___
				search_columns: [ 'Id' ],
				display_name : "InsuranceProperty",	//___EDIT__THIS___
				index: [ 'Id' ],
